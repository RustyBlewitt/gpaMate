...
var CoursePage = /** @class */ (function () {
    function CoursePage(navCtrl, navParams) {
        ...
        this.currentCourse = this.navParams.get('currentGPA');
        console.log("----");
        console.log(this.currentCourse);
    }
    CoursePage.prototype.addNewCourse = function () {
        var CourseName = prompt('Enter Course Name');
        var CourseCode = prompt('Enter Course Code');
